...
public class MapperTests {
    ...
    public void testSelectPosts() {
        List<DiscussionPost> list = discussionPostMapper.selectDiscussionPosts(0, 0, 10, 0);
        for (DiscussionPost post : list) {
            System.out.println(post);
        }

        int rows = discussionPostMapper.selectDiscussionPostRows(0);
        System.out.println(rows);
    }
    ...
    public void testSelectMessages() {
        ...
        messageMapper.selectMessages("111_112", 0, 10);
        for (Message message : list) {
            System.out.println(message);
        }
